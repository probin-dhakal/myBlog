      ...
      <div className="container">
        <form onSubmit={handleBlog}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <img
              src={mainImagePreview ? `${mainImagePreview}` : "profile.jpeg"}
              alt="mainImg"
              className="mainImg"
            />
            <input
          ...
          <div className="sub-para">
            ...
            <img
              src={
                paraOneImagePreview ? `${paraOneImagePreview}` : "profile.jpeg"
              }
              alt="subParaOneImg"
            />
            <input
          ...
          <div className="sub-para">
            ...
            <img
              src={
                paraTwoImagePreview ? `${paraTwoImagePreview}` : "profile.jpeg"
              }
              alt="subParaTwoImg"
            />
            <input
